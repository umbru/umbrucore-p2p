...
function builder(options) {
  ...
  if (!options.network) {
    options.network = umbrucore.Networks.defaultNetwork;
  }

  options.Block = options.Block || umbrucore.Block;
  options.BlockHeader = options.BlockHeader || umbrucore.BlockHeader;
  options.Transaction = options.Transaction || umbrucore.Transaction;
  options.MerkleBlock = options.MerkleBlock || umbrucore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || umbrucore.MnListDiff;
